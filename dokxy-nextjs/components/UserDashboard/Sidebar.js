    ...
    <header className="flex justify-start items-start lg:h-screen">
      <nav className="lg:flex hidden justify-start items-start p-5 lg:w-[300px] h-full sidebar">
        <div className="flex flex-col justify-start items-start gap-4 w-full">
          ...
          <button className="flex items-center gap-2 w-full rounded-lg px-7 py-2 text-xl font-medium bg-zinc-700">
            <SlCalender />
            <p>Appointments</p>
          </button>
          <button className="flex items-center gap-2 w-full rounded-lg px-7 py-2 text-xl font-medium bg-zinc-700">
      ...
      <nav className="lg:hidden flex flex-col justify-start items-start w-full px-5 py-3 sidebar">
        ...
        {isOpen && (
          <div className="flex flex-col justify-start items-start gap-4 w-full mt-3">
            ...
            <button className="flex items-center gap-2 w-full rounded-lg px-7 py-2 text-xl font-medium  bg-red-500 bg-opacity-85 hover:bg-opacity-95">
              <RiLogoutBoxRLine />
              <p>Logout</p>
            </button>
          </div>
