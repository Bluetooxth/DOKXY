    ...
    <section className="flex justify-center items-center w-full min-h-screen hero">
      <div className="flex flex-col justify-center items-center lg:container gap-5 text-center px-5 w-[95vw] py-16 md:py-0 lg:py-0">
        ...
        <div className="flex flex-wrap justify-center items-stretch gap-5">
          <div className="p-5 rounded-lg bg-slate-200 bg-opacity-20 text-white font-medium text-xl flex flex-col justify-center items-center gap-2 cursor-pointer w-[250px]">
